...
public:
    ...
    void test_pop_once()
    {
        ...
        Spy::reset();
        test_stack.container.resize(4);
        test_stack.container[0] = 5;
        test_stack.container[1] = 12;
        test_stack.container[2] = 3;
        test_stack.container[3] = 9;
        
        test_stack.pop();
        assert(test_stack.size() == 3);
        assert(test_stack.top() == 3);
        
        test_stack.container.clear();
    }
    ...
    void test_pop_twice()
    {
        custom::stack<int> test_stack;
        Spy::reset();
        test_stack.container.resize(6);
        test_stack.container[0] = 1;
        test_stack.container[1] = 11;
        test_stack.container[2] = 8;
        test_stack.container[3] = 15;
        test_stack.container[4] = 2;
        test_stack.container[5] = 9;
        
        test_stack.pop();
        test_stack.pop();
        
        assert(test_stack.size() == 4);
        assert(test_stack.top() == 15);
    ...
    void test_pop_fullToEmpty() {
        custom::stack<int> test_stack;
        Spy::reset();
        test_stack.container.resize(8);
        test_stack.container[0] = 1;
        test_stack.container[1] = 11;
        test_stack.container[2] = 27;
        test_stack.container[3] = 13;
        test_stack.container[4] = 2;
        test_stack.container[5] = 12;
        test_stack.container[6] = 6;
        test_stack.container[7] = 3;
